...
CREATE TABLE "vendors" (
    ...
    "encryptedIban" TEXT,
    "encryptedBic" TEXT,
    "encryptedBankHolder" TEXT,
    "bankInfoUpdatedAt" TIMESTAMP(3),
    "userId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "favorite_markets_userId_marketId_day_key" ON "favorite_markets"("userId", "marketId", "day");
...
-- AddForeignKey
ALTER TABLE "favorite_markets" ADD CONSTRAINT "favorite_markets_marketId_fkey" FOREIGN KEY ("marketId") REFERENCES "markets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
