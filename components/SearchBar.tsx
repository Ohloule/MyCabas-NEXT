      ...
      <form onSubmit={handleSearch} className="flex items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 rounded-l-full border-0 bg-neu-50 text-neu-900 placeholder:text-neu-400 focus:outline-none focus:ring-2 focus:ring-prin-500"
          />
        </div>
        <Button
          type="submit"
