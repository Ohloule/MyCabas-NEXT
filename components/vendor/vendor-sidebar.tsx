  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-prin-800 text-neu-50 rounded-lg shadow-lg"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-screen w-64 bg-prin-800 text-neu-50 flex flex-col z-50 transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-6 border-b border-prin-700">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={closeSidebar}
              className="lg:hidden p-1 hover:bg-prin-700 rounded"
