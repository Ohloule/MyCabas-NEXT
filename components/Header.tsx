            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="relative" ref={menuRef}>
                  ...
                  {/* Menu déroulant */}
                  {isMenuOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-principale-50 rounded-lg shadow-lg py-2 z-50 border border-neutre-100">
                      <Link
                        href="/profil"
                        onClick={() => setIsMenuOpen(false)}
                        className="flex items-center gap-3 px-4 py-2 text-sm text-neutre-700 hover:bg-principale-100 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-3 px-4 py-2 text-sm text-secondaire-600 hover:bg-principale-100 transition-colors w-full cursor-pointer"
                      >
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-principale-50 rounded-lg shadow-lg py-2 z-50 border border-neutre-100">
                    ...
                    {session.user.role === "VENDOR" && (
                      <Link
                        ...
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="flex items-center gap-3 px-4 py-2 text-sm text-neutre-700 hover:bg-principale-100 transition-colors cursor-pointer"
                      >
                        <Store className="h-4 w-4" />
                        Mon commerce
                      </Link>
