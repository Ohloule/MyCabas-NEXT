    ...
    <div className="min-h-screen bg-sec-25">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          {nextMarketDate && (
            <div className="flex items-center gap-2 rounded-lg border border-prin-200 bg-prin-50 px-3 py-1.5 text-sm text-prin-700">
          ...
          <div className="sticky top-0 z-20 -mx-4 px-4 py-3 mb-6 bg-sec-25/95 backdrop-blur-sm border-b border-neu-100 space-y-3">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-neu-400 pointer-events-none" />
                <Input
                  type="text"
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-neu-400 hover:text-neu-600"
                  >
                    <X className="h-4 w-4" />
                  </button>
                )}
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${
                    selectedCategory === null
                      ...
                      : "bg-neu-50 border border-neu-200 text-neu-600 hover:border-prin-300"
                  }`}
                >
                  Tout
                </button>
        ...
        {vendorId && vendors.find((v) => v.id === vendorId) && (
          <div className="mb-4 flex items-center justify-between rounded-lg bg-prin-50 border border-prin-200 px-4 py-3">
            <span className="text-sm font-medium text-prin-700">
              Produits de{" "}
