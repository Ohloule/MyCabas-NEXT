    ...
    return (
      <>
        ...
        <div className="align-center py-24 flex flex-col items-center gap-4">
          <Loader taille={45} />
          <p className="text-neutre-600">Préparation de votre commande...</p>
        </div>
      </>
    );
  }
    ...
    return (
      <>
        ...
        <div className="align-center py-16 text-center">
          <AlertCircle className="h-16 w-16 text-secondaire-300 mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-neutre-700 mb-2">
            Impossible de créer la commande
          </h2>
          <p className="text-neutre-500 mb-6 max-w-md mx-auto">{error}</p>
          <Link href="/panier">
  ...
  return (
    <>
      ...
      <div className="align-center py-8">
        ...
        <Link
          href="/panier"
          className="inline-flex items-center gap-1 text-sm text-neutre-600 hover:text-neutre-900 mb-6"
        >
          <ArrowLeft className="h-4 w-4" />
          Retour au panier
        </Link>
        ...
        {/* Infos marché */}
        {cart?.market && (
          <div className="flex items-center gap-2 text-sm text-neutre-600 mb-6 bg-principale-50 rounded-lg px-4 py-3">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
                  ...
                  {items.map((item) => (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <p className="font-medium text-neutre-900 truncate">
                          {item.product.name}
                        </p>
                      ...
                      <p className="font-semibold text-neutre-900 shrink-0 ml-4">
            ...
            {/* Total */}
            <div className="flex justify-between items-center px-4 py-4 bg-neutre-50 rounded-lg">
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-4">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-neutre-500 mb-6">
