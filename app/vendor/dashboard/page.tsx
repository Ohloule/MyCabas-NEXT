...
export default async function VendorDashboardPage() {
  ...
  return (
    <div>
      ...
      <p className="text-neutre-600 mb-6 md:mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-neutre-100">
          <h2 className="text-xl font-semibold text-neutre-800 mb-4">
            Prochaines commandes
          </h2>
          <p className="text-neutre-500 text-center py-8">
...
function DashboardCard({
  ...
  return (
    <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-neutre-100">
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          <p className="text-xs md:text-sm text-neutre-500 truncate">{title}</p>
          <p className="text-xl md:text-2xl font-bold text-neutre-800 mt-1">
            {value}
          </p>
        </div>
